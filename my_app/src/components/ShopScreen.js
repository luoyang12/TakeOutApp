...
class ShopScreen extends React.Component {
    ...
    componentDidMount(){
        fetch('api/shopDetail',{method:'POST',
            headers:{"Content-Type":"application/x-www-form-urlencoded"},
            body:'shopId='+this.props.match.params.number}).then(res=>res.json().then(data=>{
        ...
        return (
            <div>
                ...
                <footer>
                    ...
                    {this.state.logined?<Link to={{pathname:'/confirm',state:{select:this.state.selectDish,total:this.state.totalPrice}}}>去下单</Link>:
