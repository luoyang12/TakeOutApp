                ...
                <div className='order confirm dishes'>
                    <div>
                        <div className={'address-edit'}>
                            ...
                            <textarea className={'order-address'} onBlur={(e)=>this.setState({address:e.target.value})}/>
                            <img src={'../../icn_edit_normal.png'} alt={'编辑'}/>
                        </div>
                        <div className={'address-edit'}>
                            <span className={'order-info'}>联系电话:</span>
                            <input className={'order-phone'} onBlur={(e)=>this.setState({phoneNumber:e.target.value})}/>
                            <img src={'../../icn_edit_normal.png'} alt={'编辑'}/>
                        </div>
